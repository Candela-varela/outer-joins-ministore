...
FROM Productos P LEFT JOIN Ventas V ON P.producto_id = V. producto_id WHERE V.venta_id IS NULL
...
FROM Productos P RIGHT JOIN Ventas V ON P.producto_id = V. producto_id WHERE P.nombre IS NULL
